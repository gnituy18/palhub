...
gulp.task('watch', ['build'], function () {
  gulp.watch([ './web/feature/*' + featureGlobStr + '/**/!(index).js*(x)', './web/feature/!' + featureGlobStr + '/**/*.js' ], ['javascript'])
  gulp.watch([ './web/feature/**/*' + featureGlobStr + '.scss', './web/scss/*.scss' ], ['sass'])
  nodemon({
